package bahi.moein.omdb.ui.main.fragment
...
import bahi.moein.omdb.data.remote.State
import bahi.moein.omdb.databinding.MovieFragmentBinding
import bahi.moein.omdb.def.Const
import bahi.moein.omdb.ui.base.BaseFragment
import bahi.moein.omdb.ui.details.MovieDetailsActivity
import bahi.moein.omdb.ui.main.adapter.MovieResultAdapter
import bahi.moein.omdb.utils.EndlessScrollViewListener
import bahi.moein.omdb.utils.observe
import bahi.moein.omdb.utils.setSubTitle
import bahi.moein.omdb.utils.showToast
...
class MovieFragment : BaseFragment<MovieViewModel, MovieFragmentBinding>() {
    ...
    override fun getViewBinding(): MovieFragmentBinding = MovieFragmentBinding.inflate(layoutInflater)
